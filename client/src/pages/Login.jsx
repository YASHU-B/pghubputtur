...
const Login = () => {
    ...
    const handleGoogle = async () => {
        ...
        try {
            ...
            // After Google sign-in, user is redirected back and onAuthStateChange fires automatically.
        } catch (err) {
    ...
    return (
        <div className="min-h-[85vh] flex items-center justify-center p-4 relative overflow-hidden pb-20 md:pb-4">
            <div className="absolute top-0 left-0 w-[400px] h-[400px] bg-gradient-to-br from-orange-400/10 to-orange-400/10 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 pointer-events-none" />
            <div className="absolute bottom-0 right-0 w-[300px] h-[300px] bg-gradient-to-tl from-pink-400/10 to-orange-400/10 rounded-full blur-3xl translate-x-1/3 translate-y-1/3 pointer-events-none" />
            ...
            <div className="max-w-md w-full relative z-10 animate-fade-in">
                <div className="bg-white/85 backdrop-blur-xl rounded-xl shadow-2xl p-7 sm:p-9 border border-white/50">
                    <div className="text-center mb-7">
                        ...
                        <h2 className="text-2xl font-black text-gray-800">Owner Login</h2>
                        <p className="text-gray-400 text-sm mt-1.5">Manage your PG listings on pghub</p>
                    </div>
                    ...
                    <p className="mt-6 text-center text-gray-500 text-sm">
                        ...
                        <Link to="/register" className="text-orange-600 font-bold hover:underline">Register as Owner</Link>
                    </p>
                </div>
            </div>
        </div>
